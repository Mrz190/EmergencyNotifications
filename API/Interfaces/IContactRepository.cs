...
namespace API.Interfaces
{
    public interface IContactRepository
    {
        ...
        Task<bool> UniqueContactPhoneExists(string contactName, string phone, string contactCreator);
        Task<bool> UniqueContactPhoneExists(int id, string phone, string contactCreator);
        Task<bool> UniqueContactEmailExists(string contactName, string email, string contactCreator);
